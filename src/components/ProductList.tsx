        ...
        <table className="w-full text-sm text-left">
          <thead className="bg-gray-50 text-gray-600 font-medium border-b border-gray-200 uppercase text-xs">
            <tr>
              ...
              {isAdmin && <th className="px-6 py-4 text-right">Precio Compra (Bs)</th>}
              {isAdmin && <th className="px-6 py-4 text-right">Precio Mayor</th>}
              <th className="px-6 py-4 text-right">Precio Antes</th>
              <th className="px-6 py-4 text-right">Precio Venta</th>
              {isAdmin && <th className="px-6 py-4 text-right font-bold bg-primary-50 text-primary-800">Costo Total Lote</th>}
